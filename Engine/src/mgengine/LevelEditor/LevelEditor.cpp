...
#pragma region Quantity of enemies
	...
	editBoxPassword->setDefaultText("5");
	editBoxPassword->setTextSize(24);
	layout1->add(editBoxPassword, "quantity");
...
#pragma region Time Start
	...
	tgui::EditBox::Ptr timeStartBox = tgui::EditBox::create();
...
#pragma region Time End
	...
	tgui::EditBox::Ptr timeEndBox = tgui::EditBox::create();
...
#pragma region Enemies Speed
	...
	tgui::EditBox::Ptr speedBox = tgui::EditBox::create();
...
#pragma region Shoot Ratio
	...
	tgui::EditBox::Ptr shootRBox = tgui::EditBox::create();
...
#pragma region EnemyTypes
	...
	tgui::ComboBox::Ptr enemyTypeBox = tgui::ComboBox::create();
...
#pragma region Enemy behaviours
	...
	tgui::ComboBox::Ptr behaviourBox = tgui::ComboBox::create();
...
#pragma region Health
	...
	tgui::EditBox::Ptr healthBox = tgui::EditBox::create();
...
void LevelEditorBehaviour::SaveLevel()
{
	...
	LevelParser::SaveLevel(_currentLevel);
	cout << "Saved XML" << endl;
}
void LevelEditorBehaviour::LoadLevel()
{
	cout << "Reading XML..." << endl;
	Level* level = LevelParser::LoadLevel(config::MGE_FONT_PATH + "/demo.xml", _window);
	_currentLevel = level;
	_currentLevel->StartLevel(_world);
